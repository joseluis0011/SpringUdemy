			...
			<div class="row">
				<c:forEach items="${peliculas }" var="pelicula">
					<div class="col-xs-12 col-sm-6 col-md-3">
						...
						<h4>
							<span class="label label-default">${pelicula.calificacion}</span>
							<span class="label label-default">${pelicula.duracion }min</span>
							<span class="label label-default">${pelicula.genero}</span>
						</h4>
						<%--             <p><a class="btn btn-sm btn-primary" href="detalle/${pelicula.id }/${fechaBusqueda}" role="button">Consulta Horarios &raquo;</a></p> --%>
						<p>
							<a class="btn btn-sm btn-primary"
								href="detalle?idmovie=${pelicula.id }&fecha=${fechaBusqueda}"
